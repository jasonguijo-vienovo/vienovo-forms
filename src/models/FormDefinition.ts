...
const formDefinitionSchema = new Schema(
  {
    ...
    levelOneApproverId: { type: String, default: "", trim: true },
    levelOneApproverName: { type: String, default: "", trim: true },
    levelOneApproverEmail: { type: String, default: "", trim: true, lowercase: true },
    levelTwoApproverId: { type: String, default: "", trim: true },
    levelTwoApproverName: { type: String, default: "", trim: true },
    levelTwoApproverEmail: { type: String, default: "", trim: true, lowercase: true },
    processorApproverId: { type: String, default: "", trim: true },
    processorApproverName: { type: String, default: "", trim: true },
    processorApproverEmail: { type: String, default: "", trim: true, lowercase: true },
