...
function normalizeFormDefinitionRow(row: any): Omit<AppFormDefinition, "runtime"> {
  return {
    ...
    levelOneApproverId: row.levelOneApproverId ?? "",
    levelOneApproverName: row.levelOneApproverName ?? "",
    levelOneApproverEmail: row.levelOneApproverEmail ?? "",
    levelTwoApproverId: row.levelTwoApproverId ?? "",
    levelTwoApproverName: row.levelTwoApproverName ?? "",
    levelTwoApproverEmail: row.levelTwoApproverEmail ?? "",
      ...
      await FormDefinition.updateOne(
        { slug: form.slug },
        {
          $setOnInsert: {
            ...
            levelOneApproverId: form.levelOneApproverId,
            levelOneApproverName: form.levelOneApproverName,
            levelOneApproverEmail: form.levelOneApproverEmail,
            levelTwoApproverId: form.levelTwoApproverId,
            levelTwoApproverName: form.levelTwoApproverName,
            levelTwoApproverEmail: form.levelTwoApproverEmail,
